...
public class EtudiantController implements Initializable {
    ...
    private Etudiant selectedPerson;
    ...
    {
        selectedPerson = etudiant;
        NomLabel.setText(selectedPerson.getNom());
        PrenomLabel.setText(selectedPerson.getPrenom());
        AnneeLabel.setText(Integer.toString(selectedPerson.getAnnee()));
        ParcoursLabel.setText(selectedPerson.getParcours());
        PromoLabel.setText(selectedPerson.getPromo());
    }
